...
setTimeout(function () {
	SgpbEventListener.init = function () {
		...
		if (!popupsData || !popupsData.length) {
			return '';
		}
		...
		popupsData.each(function () {
			// Make sure the container is now visible
			jQuery(this).closest('.sgpb-main-popup-data-container-5768').css('display', 'block');
