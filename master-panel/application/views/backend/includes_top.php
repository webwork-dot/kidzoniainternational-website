      ...
      <link rel="apple-touch-icon" href="<?php echo base_url()?>app-assets/images/logo/favicon.png">
      
      <link rel="stylesheet" type="text/css" href="<?php echo base_url('app-assets/vendors/css/forms/select/select2.min.css')?>">
      <link rel="shortcut icon" type="image/x-icon" href="<?php echo base_url()?>app-assets/images/logo/favicon.png">
