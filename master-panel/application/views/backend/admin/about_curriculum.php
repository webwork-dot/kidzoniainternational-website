  ...
  <div class="col-12">
    <div class="card btlr-0" style="border-top-left-radius: 0 !important;">
      <div class="card-body py-1 my-0">
        <?php echo form_open('admin/about_curriculum/update/1', ['class' => 'add-ajax-editor-image-form', 'enctype' => 'multipart/form-data', 'onsubmit' => 'return checkForm(this);']); ?>
        <div class="row mt-1">
          ...
          <div class="col-4 col-sm-4 mb-2">
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="alt" value="<?php echo $data['alt']; ?>" placeholder="Title">
            </div>
          </div>
