   ...
   <div class="col-12">
      <div class="card">
         <div class="card-body py-1 my-0">
            <?php echo form_open('admin/branch_gallery_image/edit_post/' . $id, ['class' => 'add-ajax-editor-image-form', 'enctype' => 'multipart/form-data', 'onsubmit' => 'return checkForm(this);' ]);?>
            <div class="row">
 
               <div class="col-12 col-sm-4 mb-1">
                  <label class="form-label">Select Branch <span class="required">*</span></label>
                  <input type="text" class="form-control" placeholder="Enter Title" value="<?php echo $title['branch']; ?>" disabled>
                  <input type="hidden" name="branch_id" value="<?php echo $title['branch']; ?>">
               </div>
               
               <div class="col-12 col-sm-4 mb-1">
                  <label class="form-label">Title <span class="required">*</span></label>
                  <input type="text" class="form-control" placeholder="Enter Title" value="<?php echo $title['title']; ?>" disabled>
                  <input type="hidden" name="title" value="<?php echo $title['title']; ?>">
               </div>
                         ...
                         <p class="dm-upload-text text-center">Using button <strong>Upload Image</strong> to add more images.</p>
                          ...
                          foreach ($data as $images) {?>
                             <div class="preview-image preview-show-<?php echo $images['id']; ?>">
                                <div class="image-zone"><img id="pro-img-<?php echo $images['id']; ?>" src="<?php echo main_url() . $images['image'];?>"></div>
...
<script type="text/javascript">
    $(".remove_img").click(function(e){
        ...
        e.preventDefault(); 
        var href = '<?php echo site_url('admin/delete_branch_gallery_image_by_id/')?>'+_id;
        var btn = this;
