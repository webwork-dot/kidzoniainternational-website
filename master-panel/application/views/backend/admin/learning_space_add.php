  ...
  <div class="col-12">
    <div class="card">
      <div class="card-body py-1 my-0">
        <?php echo form_open('admin/learning_space/add_post', ['class' => 'add-ajax-editor-image-form', 'enctype' => 'multipart/form-data', 'onsubmit' => 'return checkForm(this);']); ?>
        <div class="row">
          ...
          <div class="col-12 col-md-4 mb-1">
            ...
            <input type="text" class="form-control" name="alt1" placeholder="Alt Image Tag"  required>
          </div>
          
          <div class="col-12 col-md-4 mb-1">
            <label class="form-label">Upload Pop Image<span class="required">*</span></label>
            <input type="file" class="form-control" name="heading" placeholder="Upload Image" accept="image/*" required>
          </div>
          
          <div class="col-12 col-md-4 mb-1">
            <label class="form-label">Alt Pop Image Tag<span class="required">*</span></label>
            <input type="text" class="form-control" name="alt2" placeholder="Alt Pop Image Tag"  required>
          </div>
