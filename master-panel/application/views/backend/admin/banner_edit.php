   ...
   <div class="col-12">
      <div class="card">
         <div class="card-body py-1 my-0">
            <?php echo form_open('admin/banner/edit_post/' . $id, ['class' => 'add-ajax-redirect-image-form', 'enctype' => 'multipart/form-data', 'onsubmit' => 'return checkForm(this);' ]);?>
            <div class="row">
               ...
               <div class="col-12 col-md-6 mb-1">
                    <video width="400" height="260" controls>
                        <source src="<?php echo main_url() . $data['file'];?>" type="video/mp4">
                        <source src="<?php echo main_url() . $data['file'];?>" type="video/webm">
                        <source src="<?php echo main_url() . $data['file'];?>" type="video/ogg">
