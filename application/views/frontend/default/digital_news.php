        ...
        >
          <div class="bt_bb_background_image_holder_wrapper">
            <div
              ...
              style="
                background-image: url(<?php echo base_url();?>assets/images/blogs-banner.jpg);"
            ></div>
          </div>
         ...
         <?php if(!empty($digital_news)):?>  
         <section id="custom-blog-section">
            <div class="container">
                <div class="row d-flex"> 
                <?php foreach($digital_news as $blog){?>
                    <div class="col-12 col-md-6 col-lg-4 p-3"> 
                    <a target="_blank" href="<?php echo $blog['url'];?>">
                        <div class="box custom-box"> 
                            <img src="<?php echo base_url() . $blog['image'];?>" class="img-fluid" alt="<?php echo $blog['alt'];?>">
...
<!--<script src="<?php echo base_url();?>assets/js/bootstrap5-3-2.bundle.min.js" ></script>-->