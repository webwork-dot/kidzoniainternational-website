...
<div class="row mt-0">
   <div class="col-lg-12">
      <div class="col-md-12 h-enquiry">
          ...
          <form action="<?php echo base_url();?>ajax_admission_otp_enquiry" class="add-ajax-modal-form mt-10" onsubmit="return checkMForm(this);">
            <div class="row">
 ...
 <script>  
  ...
  $('.add-ajax-modal-form').submit(function(e) {
    ...
    function resendOTP(){
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url(); ?>home/resend_admission_otp',
