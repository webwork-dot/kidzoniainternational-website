    ...
    <div class="btContent">
      <div class="bt_bb_wrapper">
        ...
        <section data-bb-version="4.5.9" id="bt_bb_section656da16ab035a"
                              ...
                              <div class="bt_bb_image" data-bt-override-class="{}">
                                <span>
                                  <img loading="lazy" decoding="async" width="65" height="45"
                                    src="<?= base_url(); ?>uploads/2023/07/Leaf_Element.png"
                                    class="attachment-full size-full" />
                                </span>
                              </div>
                            </div>
                            ...
                            <div class="item item--style-1"
                              ...
                              <svg class="item__svg" viewBox="0 0 500 500" width="300" height="300">
                                ...
                                <g clip-path="url(#bt_bb_organic_animation_656da16ab0aa3)" class="item__img__g">
                                  <image class="item__img" xlink:href="<?= base_url(); ?>uploads/2023/07/BG1.jpg" x="0"
                                    y="0" height="100%" width="100%" />
                                </g>
                                <g clip-path="url(#bt_bb_organic_animation_656da16ab0aa3)" class="item_hover__img_g">
                                  <image class="item_hover__img" xlink:href="<?= base_url(); ?>uploads/2023/07/BG1.jpg"
                              ...
                              <svg class="item__svg" viewBox="0 0 500 500" width="300" height="300">
                                ...
                                <g clip-path="url(#bt_bb_organic_animation_656da16ab0dd7)" class="item__img__g">
                                  <image class="item__img" xlink:href="
                                                <?= base_url(); ?>uploads/2023/07/BG2.jpg" x="0" y="0" height="100%"
                                    width="100%" />
                                </g>
                                <g clip-path="url(#bt_bb_organic_animation_656da16ab0dd7)" class="item_hover__img_g">
                                  <image class="item_hover__img" xlink:href="<?= base_url(); ?>uploads/2023/07/BG2.jpg"
                                    x="0" y="0" height="100%" width="100%" />
                                </g>
                              </svg>
                              <div class="item__meta">
                          ...
                          <div
                            ...
                            <span>
                              <img loading="lazy" decoding="async" width="520" height="640"
                                src="<?= base_url(); ?>assets/images/curriculumbranch.png?tr=w-600"
                                class="attachment-full size-full"
                            ...
                            <div class="item item--style-1"
                              ...
                              <svg class="item__svg" viewBox="0 0 500 500" width="300" height="300">
                                ...
                                <g clip-path="url(#bt_bb_organic_animation_656da16ab1542)" class="item__img__g">
                                  <image class="item__img" xlink:href="
                                                <?= base_url(); ?>uploads/2023/07/BG4.jpg" x="0" y="0" height="100%"
                                    width="100%" />
                                </g>
                                <g clip-path="url(#bt_bb_organic_animation_656da16ab1542)" class="item_hover__img_g">
                                  <image class="item_hover__img" xlink:href="<?= base_url(); ?>uploads/2023/07/BG4.jpg"
                                    x="0" y="0" height="100%" width="100%" />
                                </g>
                              </svg>
                              <div class="item__meta">
                            ...
                            <div class="item item--style-1"
                              ...
                              <svg class="item__svg" viewBox="0 0 500 500" width="300" height="300">
                                ...
                                <g clip-path="url(#bt_bb_organic_animation_656da16ab1b13)" class="item__img__g">
                                  <image class="item__img" xlink:href="
                                                <?= base_url(); ?>uploads/2023/07/BG3.jpg" x="0" y="0" height="100%"
                                    width="100%" />
                                </g>
                                <g clip-path="url(#bt_bb_organic_animation_656da16ab1b13)" class="item_hover__img_g">
                                  <image class="item_hover__img" xlink:href="<?= base_url(); ?>uploads/2023/07/BG3.jpg"
                                    x="0" y="0" height="100%" width="100%" />
                                </g>
                              </svg>
                              <div class="item__meta">
          ...
          <div class="bt_bb_section_bottom_section_coverage_image">
            <img decoding="async" src="<?= base_url(); ?>uploads/2022/04/bottom_white_wave_03.png"
              alt="bt_bb_section_bottom_section_coverage_image" />
          </div>
        </section>
                        ...
                        <div class="bt_bb_column_content_inner">
                          <div data-bb-version="4.6.1"
                            ...
                            <div class="bt_bb_card_image">
                              <img decoding="async" src="<?= base_url(); ?>uploads/2023/07/Playgroup.jpg?tr=w-300"
                                alt="Play Group">
                            </div>
                          </div>
                          <div
                      ...
                      <div class="bt_bb_column_content">
                        <div class="bt_bb_column_content_inner">
                          <div data-bb-version="4.6.1"
                            ...
                            <div class="bt_bb_card_image">
                              <img decoding="async" src="<?= base_url(); ?>uploads/2023/07/Nursery.jpg?tr=w-300"
                                alt="Nursery">
                            </div>
                          </div>
                          <div
                      ...
                      <div class="bt_bb_column_content">
                        <div class="bt_bb_column_content_inner">
                          <div data-bb-version="4.6.1"
                            ...
                            <div class="bt_bb_card_image">
                              <img decoding="async" src="<?= base_url(); ?>uploads/2023/07/Kidzo-Junior.jpg?tr=w-300"
                                alt="Kidzo Junior">
                            </div>
                          </div>
                          <div
                      ...
                      <div class="bt_bb_column_content">
                        <div class="bt_bb_column_content_inner">
                          <div data-bb-version="4.6.1"
                            ...
                            <div class="bt_bb_card_image">
                              <img decoding="async" src="<?= base_url(); ?>uploads/2023/07/Kidzo-Senior.jpg?tr=w-300"
                                alt="Kidzo Senior">
                            </div>
                          </div>
                          <div
                      ...
                      <div class="bt_bb_column_content">
                        <div class="bt_bb_column_content_inner">
                          <div data-bb-version="4.6.1"
                            ...
                            <div class="bt_bb_card_image">
                              <img decoding="async" src="<?= base_url(); ?>uploads/2023/07/Daycare.jpg?tr=w-300"
                                alt="Day Care">
                            </div>
                          </div>
                          <div
                 ...
                 <div class="bt_bb_cell_inner">
                    <div class="row align-items-center text-center text-md-start">
                       <div class="col-md-8 mb-3 mb-md-0" style="padding-left: 30px;">
                          ...
                          <p style="color: #666; margin: 0; font-size: 15px;">Read our latest monthly publications, events, and school updates in PDF format<?= !empty($location_name) ? ' for ' . html_escape($location_name) : ''; ?>.</p>
                       </div>
                       <div class="col-md-4 text-center text-md-end" style="padding-right: 30px;">
                          <?php $branch_slug_param = !empty($branch_slug) ? $branch_slug : (!empty($branch['slug']) ? $branch['slug'] : (!empty($param1) ? $param1 : '')); ?>
