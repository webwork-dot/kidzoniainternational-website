...
function smallAjaxModal(url, header)
{
    ...
    jQuery('#small-modal .modal-body').html('<div style="text-align:center;"><img src="<?php echo base_url().'assets/global/bg-pattern-light.svg'; ?>" /></div>');
...
{
    // SHOWING AJAX PRELOADER IMAGE
    jQuery('#scrollable-modal .modal-body').html('<div style="text-align:center;min-height:200px;"><img src="<?php echo base_url().'assets/global/bg-pattern-light.svg'; ?>" style="height: 300px;"/></div>');
...
function showAjaxCareerModal(url, header)
{
    // SHOWING AJAX PRELOADER IMAGE
    jQuery('#career-modal .modal-body').html('<div style="text-align:center;min-height:200px;"><img src="<?php echo base_url().'assets/global/bg-pattern-light.svg'; ?>" style="height: 300px;"/></div>');
    jQuery('#career-modal .modal-title').html('...');
    // LOADING THE AJAX MODAL
    jQuery('#career-modal').modal('show', {backdrop: 'true'});
    ...
    jQuery.ajax({
        ...
        success: function(response)
        {
            jQuery('#career-modal .modal-content').html(response);
            jQuery('#career-modal .modal-title').html(header);
        }
    });
}
...
{
    // SHOWING AJAX PRELOADER IMAGE
    jQuery('#enquiry-modal .modal-body').html('<div style="text-align:center;min-height:200px;"><img src="<?php echo base_url().'assets/global/bg-pattern-light.svg'; ?>" style="height: 300px;"/></div>');
    jQuery('#enquiry-modal .modal-title').html('...');
    // LOADING THE AJAX MODAL
    jQuery('#enquiry-modal').modal('show', {backdrop: 'true'});
 ...
 <div class="modal fade text-start career-modal"  id="career-modal" data-bs-backdrop="static" tabindex="-1" aria-labelledby="myModalLabel33" aria-hidden="true">
...
<div id="ajax-alert-modal" class="modal fade" data-bs-backdrop="static"  tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-sm"> 
        <div class="modal-content">
            <div class="modal-body p-2">
                <div class="text-center">
                    <i class="feather icon-ajax-alert-circle text-info h1"></i>
                    <h4 class="mt-1"><?php echo get_phrase("heads_up"); ?>!</h4>
                    <p class="mt-1 modal-title"><?php echo get_phrase("are_you_sure"); ?></p>
