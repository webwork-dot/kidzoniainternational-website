        ...
        >
          <div class="bt_bb_background_image_holder_wrapper">
            <div
              ...
              style="
                background-image: url(<?php echo base_url();?>assets/images/kidzonia-gallery-banner.jpg);"></div>
            
            <!--featured_image_portfolio.jpg-->
          </div>
                          ...
                          >
                            <h1 class="bt_bb_headline_tag">
                              <span class="bt_bb_headline_content"
                                ><span>Kidzonia Gallery</span></span
                              >
                            </h1>
                          </header>
                          <div
                            ...
                            >
                              <div class="bt_bb_column_inner_content">
                                <div
                                  ...
                                  class="bt_bb_image bt_bb_shape_soft-rounded bt_bb_target_self bt_bb_align_inherit bt_bb_hover_style_simple bt_bb_content_display_always bt_bb_content_align_middle bt_bb_right_negative_margin_none bt_bb_left_negative_margin_none"
                                ...
                                >
                                  <a
                                    ...
                                    ><img
                                      ...
                                      width="600"
                                      height="600"
                                      src="<?php echo base_url() . $d['pic'];?>"
                                      class="attachment-full size-full campus_img"
                                      alt="<?php echo $d['name'];?>"
                                      data-full_image_src="<?php echo base_url() . $d['pic'];?>"
                                      title="teachers day (1)"
                                      srcset="
                                        <?php echo base_url() . $d['pic'];?>         600w,
                                        <?php echo base_url() . $d['pic'];?> 160w,
                                        <?php echo base_url() . $d['pic'];?> 320w
                                      "
